            ...
            <div className="max-w-[1152px] m-auto relative">
                ...
                <section className="text-slate-100 mt-16">
                    ...
                    <div className="flex gap-11 px-6 py-10 flex-wrap justify-center items-center">
                        ...
                        <div className="bg-[#090F20] rounded-full w-24 aspect-square flex justify-center flex-col items-center gap-2 shadow-md">
                            <p className="font-medium text-muted-foreground text-xs">Flask</p>
                            <Image src={'/flask.svg'} alt="skill image" width={40} height={40} />
                        </div>
                        <div className="bg-[#090F20] rounded-full w-24 aspect-square flex justify-center flex-col items-center gap-2 shadow-md">
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-8">
                        <div className="flex gap-10">
                            <div className="flex flex-col justify-between">
                                <div>
                                    <h4 className="text-xl font-medium mt-4">Python ORM</h4>
                                    <p className="text-sm text-muted-foreground">Python, Pytest, FastAPI, PostgreSQL, React</p>
                                    <p className="mt-6">Python migration engine for ORM supporting Postgres and SQLite, made with two other colleagues. Additionally features web UI for CRUD operations. Strict typesafety with newest Python features, thorough tests, rich CI/CD pipeline.</p>
                                </div>
                                <div className="flex gap-4 items-center justify-start mt-8">
                                    <Button >
                                        <Link href={'https://github.com/sysy-inc/zprp-23z-python-orm'} className="flex items-center justify-center gap-2">
                                            <p>See code</p>
                                            <Code2 />
                                        </Link>
                                    </Button>
