...
import '../styles/coding-cat.css'
import { useEffect } from 'react';

export default function CodingCat() {
    ...
    return (
        <svg className='absolute h-[500px] w-[470px]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 783.55 354.91">
            <g id="bongo-cat">
                <g className="head">
